...
#include  "xas/gpl/nix_util.h"  /* Network I/O Handler definitions.     */
#include  "xas/gpl/str_util.h"  /* String manipulation functions.       */
#include  "xas/gpl/tcp_util.h"  /* TCP/IP network utilities.            */
#include  "xas/gpl/vperror.h"   /* VPERROR() definitions.               */
#include  "xas/gpl/port_util.h" /* Listening port utilities.            */
