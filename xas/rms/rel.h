...
struct _rel_s {
    ...
    int (*_last)(rel_t *, void *, ssize_t *);
    int (*_first)(rel_t *, void *, ssize_t *);
    int (*_normalize)(rel_t *, void *, void *);
    int (*_find)(rel_t *, void *, int, int (*compare)(void *, void *), off_t *);
    int (*_search)(rel_t *, void *, int, int (*compare)(void *, void *), int (*capture)(rel_t *, void *, queue *), queue *);
...
extern int rel_find(rel_t *, void *, int,  int (*compare)(void *, void *), off_t *);
extern int rel_search(rel_t *, void *, int,  int (*compare)(void *, void *), int (*capture)(rel_t *, void *, queue *), queue *);
