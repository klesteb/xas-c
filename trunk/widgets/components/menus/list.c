...
component_t *list_menu_create(window_t *window, int startx, int starty, int height, int width, int tab, int (*display)(const char *), menus_list_t *list, int list_size) {
