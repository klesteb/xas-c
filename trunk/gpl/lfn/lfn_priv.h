...
#include  "xas/gpl/opt_util.h"          /* Option scanning definitions. */
#include  "xas/gpl/str_util.h"          /* String manipulation functions. */
#include  "xas/gpl/tcp_util.h"          /* TCP/IP networking utilities. */
#include  "xas/gpl/tv_util.h"           /* "timeval" manipulation functions. */
#include  "xas/gpl/vperror.h"           /* VPERROR() definitions. */
#include  "xas/gpl/lfn_util.h"          /* LF-terminated network I/O. */
#include  "xas/gpl/meo_util.h"          /* memory operations */
