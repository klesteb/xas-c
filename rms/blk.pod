...
=head2 I<blk_t *blk_create(char *filename, int retries, int timeout)>
...
=head2 I<int blk_destroy(blk_t *self)>
...
=head2 I<int blk_override(blk_t *self, item_list_t *items)>
...
=head2 I<int blk_compare(blk_t *this, blk_t *that)>
...
=head2 I<char *blk_version(blk_t *self)>
...
=head2 I<int blk_open(blk_t *self, int flags, mode_t mode)>
...
=head2 I<int blk_close(blk_t *self)>
...
=head2 I<int blk_read(blk_t *self, void *buffer, size_t size, ssize_t *count)>
...
=head2 I<int blk_write(blk_t *self, void *buffer, size_t size, ssize_t *count)>
...
=head2 I<int blk_lock(blk_t *self, off_t offset, off_t length)>
...
=head2 I<int blk_unlock(blk_t *self)>
...
=head2 I<int blk_seek(blk_t *self, off_t offset, int whence)>
...
=head2 I<int blk_tell(blk_t *self, off_t *offset)>
...
=head2 I<int blk_exists(blk_t *self, int *exists)>
...
=head2 I<int blk_stat(blk_t *self, struct stat *buffer)>
...
=head2 I<int blk_unlink(blk_t *self)>
...
=head2 I<int blk_size(blk_t *self, off_t *size)>
